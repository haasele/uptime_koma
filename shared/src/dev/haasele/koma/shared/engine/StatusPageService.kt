...
class StatusPageService(
    ...
    suspend fun view(slug: String, beatCount: Int = 200): StatusPageView? {
        val page = statusPages.getBySlug(slug) ?: return null
        return buildView(page.id, beatCount)
    }

    suspend fun viewById(pageId: Long, beatCount: Int = 200): StatusPageView? = buildView(pageId, beatCount)
