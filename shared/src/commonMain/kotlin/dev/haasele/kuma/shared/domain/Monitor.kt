...
data class Monitor(
    ...
    fun validate(): List<String> {
        ...
        if (intervalSeconds < MIN_INTERVAL_SECONDS) errors += "Interval must be at least $MIN_INTERVAL_SECONDS seconds"
        if (retryIntervalSeconds < MIN_INTERVAL_SECONDS) errors += "Retry interval must be at least $MIN_INTERVAL_SECONDS seconds"
    ...
    companion object {
        const val MIN_INTERVAL_SECONDS = 20
    }
}
